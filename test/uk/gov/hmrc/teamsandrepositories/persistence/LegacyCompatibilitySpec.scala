...
class LegacyCompatibilitySpec
  ...
  private val repo1 = GitRepository("repo1", "desc 1", "git/repo1", Instant.now(), Instant.now(), isPrivate = false, Service, None, None, Nil, None, isArchived = false, "main", branchProtection = None, isDeprecated = false, List("team1"))
  private val repo2 = GitRepository("repo2", "desc 2", "git/repo2", Instant.now(), Instant.now(), isPrivate = false, Service, None, None, Nil, None, isArchived = true, "main", branchProtection = None, isDeprecated = false, List("team1"))
