...
package uk.gov.hmrc.teamsandrepositories.connectors.signer
...
class AwsSignerSpec extends AnyWordSpecLike with Matchers with OptionValues with ScalaFutures {
